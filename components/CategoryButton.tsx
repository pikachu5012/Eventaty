...
export default function CategoryButton({
  ...
  return (
    <div className="w-2/3 md:w-1/3 lg:w-1/5 my-4 mx-auto group">
      <Button
        onClick={handleClick}
        className="w-full flex flex-col justify-center items-center py-18 bg-linear-to-t from-[#1E293B] to-primary cursor-pointer  hover:bg-secondary hover:bg-none hover:text-primary"
      >
