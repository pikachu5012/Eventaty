...
export function EventForm({
  ...
  const handleAddTicket = () => {
    ...
    setValue("tickets", [
      ...currentTickets,
      { type: "General", description: "", multiplier: 1 },
    ]);
  };
  ...
  // Handler for venue selection - auto-populate capacity
  const handleVenueChange = (venueId: string) => {
    setValue("venueId", venueId);
    const selectedVenue = venues.find((v) => v._id === venueId);
    if (selectedVenue) {
      setValue("totalCapacity", selectedVenue.capacity);
    }
  };
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-in fade-in duration-200 m-0"
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                {/* Category */}
                <div className="space-y-2">
                  <Label className="text-primary/70 text-sm">{t('category')}</Label>
                  <Controller
                    name="categoryId"
                    control={control}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div className="space-y-2">
                  <Label className="text-primary/70 text-sm">{t('venue')}</Label>
                  <Controller
                    name="venueId"
                    control={control}
                    rules={{ required: t('errors.venueRequired') }}
                    render={({ field }) => (
                      <Select
                ...
                <div className="space-y-2">
                  <Label className="text-primary/70 text-sm">{t('capacity')}</Label>
                  <Input
                    type="number"
                    ...
                    {...register("totalCapacity", {
                      required: t('errors.capacityRequired'),
                      min: { value: 1, message: t('errors.capacityMin') },
                    })}
                    required
                  />
                </div>
            ...
            <div className="space-y-4 pt-4 border-t border-gray-100">
              <div className="flex items-center justify-between">
                ...
                >
                  <Plus className="h-3.5 w-3.5 mr-1.5" /> {t('addTicket')}
                </Button>
              </div>
                          ...
                          render={({ field }) => (
                            <Select
                              onValueChange={(value) => {
                                ...
                                // Auto-set multiplier to 1 for General tickets
                                if (value === "General") {
                                  setValue(`tickets.${index}.multiplier`, 1);
                                }
                              }}
                              value={field.value}
                            >
                        ...
                        <div>
                          ...
                          <Input
                            ...
                            {...register(
                              ...
                              {
                                required: t('errors.multiplierRequired'),
                                min: {
                                  value: 1,
                                  message: t('errors.multiplierMin'),
                                },
                              },
                            )}
                            disabled={
