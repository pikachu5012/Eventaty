            ...
            <Link key={event._id} href={`/events/${event._id}`} className="block h-full">
              ...
              >
                <Card className="pt-0 rounded-xl overflow-hidden group bg-transparent border-none shadow-none h-full flex flex-col">
                  ...
                  <CardContent className="grow flex flex-col justify-between p-5">
                    <div>
                      <h3 className="text-lg font-bold text-foreground mb-1 line-clamp-1 group-hover:text-[#7C3AED] transition-colors">
                        {eventName}
                      </h3>
                    ...
                    <div className="flex justify-between items-center pt-4 mt-4 border-t border-gray-100 dark:border-slate-800/50">
