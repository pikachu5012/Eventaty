...
class App {
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    const defaultItems = [
      { image: `/swipper1.png`, text: 'Bridge' },
      { image: `/swipper2.jpg`, text: 'Desk Setup' },
      { image: `/swipper3.jpg`, text: 'Waterfall' },
      { image: `/ninja.png`, text: 'Strawberries' },
      { image: `/swipper1.png`, text: 'Deep Diving' },
      { image: `/swipper2.jpg`, text: 'Train Track' },
      { image: `/swipper3.jpg`, text: 'Santorini' },
      { image: `/ninja.png`, text: 'Blurry Lights' },
      { image: `/swipper1.png`, text: 'New York' },
      { image: `/swipper2.jpg`, text: 'Good Boy' },
      { image: `/swipper3.jpg`, text: 'Coastline' },
      { image: `/ninja.png`, text: 'Palm Trees' }
    ];
  ...
  onTouchUp(e) {
    ...
    if (this.start !== undefined && endX !== undefined && this.startY !== undefined && endY !== undefined) {
      const distance = Math.hypot(endX - this.start, endY - this.startY);
  ...
  handleClick(clientX, clientY) {
    ...
    this.mouse[0] = ((clientX - rect.left) / rect.width) * 2 - 1;
    this.mouse[1] = -((clientY - rect.top) / rect.height) * 2 + 1;
    ...
    if (hits.length > 0) {
      ...
      if (clickedMedia && this.onItemClick) {
        this.onItemClick(clickedMedia.text, clickedMedia.index);
      }
    }
  }
  onWheel(e) {
