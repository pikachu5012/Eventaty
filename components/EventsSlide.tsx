...
export default function EventSlide({ event }: EProps) {
  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-center bg-transparent p-6 max-w-[1440px] mx-auto">
      {/* left side - Card */}
      <div className="pe-0 md:pe-2 w-full md:w-1/2 lg:w-1/3">
        <div className=" shrink-0 rounded-[56px] bg-card p-10 h-[350px] flex flex-col justify-between shadow-sm">
          <div>
