...
import { Github, Linkedin, User, Mail, Compass, Eye, Heart, Award, Lightbulb, Sparkles } from "lucide-react";
    ...
    <>
      <section className={inter.className} style={{ minHeight: "100dvh" }}>
        ...
        <div className="mx-auto flex flex-col items-center justify-center gap-y-2 py-10  relative bg-linear-to-r from-[#111111] via-[#1E293B] to-[#111111]">
          <Sparkles className="absolute top-4 right-3 md:right-7 text-violet-400 w-8 h-8 md:w-10 md:h-10 animate-pulse" />
          <h1 className="text-strongCream px-1 text-2xl md:text-4xl text-center font-normal mt-5 md:mt-10">
            {t('heroTitle')}
          </h1>
          <p className="text-slate-300 px-1 text-xs sm:text-base text-center font-thin max-w-xs md:max-w-lg mx-auto">
            {t('heroSubtitle')}
          </p>
        </div>
